    ...
    tokio::spawn(async move {
        ...
        loop {
            ...
            let sync_data = ckbadger_common::SyncProgressData {
                ...
                adaptive_max_inflight_limit: adaptive.as_ref().map(|s| s.max_inflight_limit),
                ...
                adaptive_at_floor: adaptive.as_ref().map(|s| s.at_floor),
                adaptive_last_adjusted_at: adaptive.as_ref().and_then(|s| s.last_adjusted_at),
                adaptive_last_adjustment: adaptive.as_ref().and_then(|s| s.last_adjustment.clone()),
