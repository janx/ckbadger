use anyhow::Result;
use ckbadger_common::{
    format_duration_smart, AdaptiveLastAdjustmentData, MemoryStatsData, PipelineProgressData,
...
impl TuiDb {
    ...
    fn build_from_progress(
        ...
        SyncStatusRow {
            ...
            adaptive_max_inflight_limit: progress.adaptive_max_inflight_limit,
            ...
            adaptive_at_floor: progress.adaptive_at_floor,
            adaptive_last_adjusted_age_secs: progress
                .adaptive_last_adjusted_at
                .map(|ts| (chrono::Utc::now().timestamp() - ts).max(0)),
            adaptive_last_adjustment: progress.adaptive_last_adjustment.clone(),
    ...
    fn build_from_status(
        ...
        Ok(SyncStatusRow {
            ...
            adaptive_max_inflight_limit: None,
