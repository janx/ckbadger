...
crates/
  ...
  ckbadger-store/ # Embedded RocksDB storage engine (dual-store, 59 domain + 1 append-only CFs)
...
docs/STORE_SCHEMA.md         # Column families reference (59 domain + 1 append-only)
