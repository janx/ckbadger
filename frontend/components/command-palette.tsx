...
const COMMANDS: CommandItem[] = [
  ...
  {
    id: 'go-inventory-tokens',
    label: 'Go to Tokens',
    keywords: ['inventory', 'token', 'tokens', 'asset'],
  ...
  },
  {
    id: 'go-fiber',
    label: 'Go to Fiber',
    keywords: ['fiber', 'channel', 'channels', 'payment'],
    href: '/fiber/channels',
  },
...
const SHORTCUT_HINTS: ShortcutHint[] = [
  ...
  { keys: 'g a', description: 'Go to Tokens' },
