...
export default function SecondaryIssuancePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <TerminalPanel>
          <TerminalPanelHeader indicator="active">Secondary Issuance</TerminalPanelHeader>
          <TerminalPanelContent className="p-6">
            ...
            {data && (
              <>
                <StackedAreaChart data={data.data} series={data.series} height={400} isPercentage />
                ...
                <ChartCalculationNote
                  description={
                    getChartDescription('chart-secondary-issuance', {
                      seriesLabels: data.series.map((s) => s.label),
                    }) ?? {
                      overview: 'Shows secondary issuance category split over time.',
                      legendItems: [],
                    }
                  }
                />
