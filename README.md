...
| **Storage**       | RocksDB (54 domain + 1 append-only CFs, ckbadger-store) | Embedded dual-store data engine |
...
│   ├── ckbadger-store/     # Embedded RocksDB storage engine (54 domain + 1 append-only CFs)
