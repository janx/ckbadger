...
-- ===========================================
-- 15. Materialized Views for Statistics
-- Pre-aggregate data for chart queries
-- ===========================================
...
-- Materialized view for daily block statistics
...
AS SELECT
    toDate(fromUnixTimestamp64Milli(b.timestamp)) as date,
    avgState(b.compact_target) as avg_compact_target,
