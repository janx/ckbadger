...
| ------------------------ | --------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| Indexer                  | `crates/indexer/src/main.rs`, `crates/indexer/src/lib.rs` | `crates/indexer/src/sync/indexer.rs`, `crates/indexer/src/parser/*.rs`, `crates/indexer/src/db/writer/*.rs`, `crates/indexer/src/verify/mod.rs`       | `cargo test -p ckbadger-indexer` + inline `#[cfg(test)]`            |
...
| Frontend                 | `frontend/app/layout.tsx`, `frontend/app/page.tsx`        | `frontend/app/**/page.tsx`, `frontend/lib/api.ts`, `frontend/components/**/*.tsx`                                                                     | `cd frontend && pnpm test`, `cd frontend && pnpm type-check`        |
...
| Frontend page or data view | `frontend/app/**/page.tsx`                                                                                      | `frontend/components/**`, `frontend/lib/api.ts`, `frontend/__tests__/**`                       |
