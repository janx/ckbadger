# ckbadger-store Column Families (39 total)
...
| `reorg_cells_created_by_block`  | block_number + outpoint      | empty                   | Reorg rollback index for created cells       |
| `reorg_consumed_cells_by_block` | block_number + outpoint      | empty                   | Reorg rollback index for consumed cells      |
